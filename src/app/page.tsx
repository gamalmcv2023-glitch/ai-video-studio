...
export default function Home() {
  ...
  return (
    <main id="home" className="site-shell">
      ...
      <section className="tool-strip" aria-label="أقسام المنصة"><Link href="/create" className="tool-card active"><span className="tool-index">01</span><span><b>Seedance 2.5</b><small>محرك الفيديو</small></span><span className="arrow">↗</span></Link><Link href="/create" className="tool-card"><span className="tool-index">02</span><span><b>Text to Video</b><small>فكرة إلى فيديو</small></span><span className="arrow">↗</span></Link><Link href="#script" className="tool-card"><span className="tool-index">03</span><span><b>Script Studio</b><small>سكريبت دقيق</small></span><span className="arrow">↗</span></Link></section>
