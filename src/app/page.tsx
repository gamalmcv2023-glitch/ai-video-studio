  ...
  return (
    <main id="home" className="site-shell">
      ...
      <header className="topbar">
        ...
        <nav className="desktop-nav" aria-label="التنقل الرئيسي"><a href="#home">الرئيسية</a><Link href="/create">إنشاء فيديو</Link><Link href="/astra">أسترا</Link><Link href="/script-studio">Script Studio</Link><a href="#work">أعمالي</a></nav>
      ...
      <section className="tool-strip" aria-label="الأدوات الأساسية"><Link href="/create" className="tool-card active"><span className="tool-index">01</span><span><b>Text to Video</b><small>فكرة إلى فيديو</small></span><span className="arrow">↗</span></Link><Link href="/create" className="tool-card"><span className="tool-index">02</span><span><b>Image to Video</b><small>صورة إلى حركة</small></span><span className="arrow">↗</span></Link><Link href="/astra" className="tool-card"><span className="tool-index">03</span><span><b>شات جي بي تي أسترا</b><small>رفيقك الإبداعي</small></span><span className="arrow">↗</span></Link><Link href="/script-studio" className="tool-card"><span className="tool-index">04</span><span><b>Script Studio</b><small>سكريبت دقيق</small></span><span className="arrow">↗</span></Link></section>
